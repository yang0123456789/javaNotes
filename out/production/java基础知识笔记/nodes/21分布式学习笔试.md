...
​             ![zookeeper简介](21分布式学习笔试.assets/20141108213347_577.png)
...
![img](21分布式学习笔试.assets/v2-e239d825160aca3e29495483da3d8bac_1440w.jpg)
...
![img](21分布式学习笔试.assets/v2-546926059b2d43d408cd8d70b72acfe4_1440w.png)
...
![img](21分布式学习笔试.assets/v2-0965ceb2c1e10113f858c56b23563a1c_1440w.png)
...
![img](21分布式学习笔试.assets/v2-eb1c23ad2f4d25fc1a9a5c3046a892d7_1440w.png)



- 同理，接下来会分配t1-1，虽然C1和C2都订阅了t1，但是由于C1排在C2前面，因而该分区会分配给C1，即：

![img](21分布式学习笔试.assets/v2-f2298aff2fe5aab4479e3b2a1d659cf0_1440w.png)



- 最后，尝试将t0-0分配给C0，由于C0订阅了t0，因而分配成功，最终的分配结果为：

![img](21分布式学习笔试.assets/v2-790c7480cfd03c357e306cc54e1ced40_1440w.png)
...
![Leader选举流程](21分布式学习笔试.assets/15.png)
...
![image-20201111210246321](21分布式学习笔试.assets/image-20201111210246321.png)
...
![在这里插入图片描述](21分布式学习笔试.assets/20190918205837441.png)
使用两个线程:
main线程和sender线程
...
offset + 1
图示:
![在这里插入图片描述](21分布式学习笔试.assets/20190918211133620.png)
生产者发送数据offset是从0开始的
![在这里插入图片描述](21分布式学习笔试.assets/20190918211237148.png)
...
**如果producer的流量增大，当前的topic的parition数量=consumer数量，这时候的应对方式就是很想扩展：增加topic下的partition，同时增加这个consumer group下的consumer。**
 ...
 ![img](21分布式学习笔试.assets/20170107211358384)       
...
\- **Partition ack：**当ack=1，表示producer写partition leader成功后，broker就返回成功，无论其他的partition follower是否写成功。当ack=2，表示producer写partition leader和其他一个follower成功的时候， broker就返回成功，无论其他的partition follower是否写成功。当ack=-1 [parition的数量]的时候，表示只有producer全部写成功的时候，才算成功，kafka broker才返回成功信息。**这里需要注意的是，如果ack=1的时候，一旦有个broker宕机导致partition的follower和leader切换，会导致丢数据。**
  ...
  ![img](21分布式学习笔试.assets/20170107211558246)

![img](21分布式学习笔试.assets/20170107211616996)
...
![img](21分布式学习笔试.assets/20170107211730692)
...
- **2.3  kafka拓扑结构**
  ...
  ![img](21分布式学习笔试.assets/20170107211822608)
...
![img](21分布式学习笔试.assets/20170107212036116)
...
![img](21分布式学习笔试.assets/20170107212205785)

以上述图2中一对segment file文件为例，说明segment中index<—->data file对应关系物理结构如下：

![img](21分布式学习笔试.assets/20170107212224538)
...
![img](21分布式学习笔试.assets/20170107212325100)
...
![img](21分布式学习笔试.assets/20170107212450867)
...
![img](21分布式学习笔试.assets/20170107212535915)
...
![img](21分布式学习笔试.assets/20170107212704151)
...
![img](21分布式学习笔试.assets/20170107212800371)
...
[![在这里插入图片描述](21分布式学习笔试.assets/19816137-8758f092be21e6f7.gif)](https://upload-images.jianshu.io/upload_images/19816137-8758f092be21e6f7.gif?imageMogr2/auto-orient/strip)
...
[![在这里插入图片描述](21分布式学习笔试.assets/19816137-bb466f6b0135bb71)](https://upload-images.jianshu.io/upload_images/19816137-bb466f6b0135bb71?imageMogr2/auto-orient/strip|imageView2/2/w/1240)
...
[![在这里插入图片描述](21分布式学习笔试.assets/19816137-dad0e43fc31f4536)](https://upload-images.jianshu.io/upload_images/19816137-dad0e43fc31f4536?imageMogr2/auto-orient/strip|imageView2/2/w/1240)
...
[![在这里插入图片描述](21分布式学习笔试.assets/19816137-eeedbd49be096c05)](https://upload-images.jianshu.io/upload_images/19816137-eeedbd49be096c05?imageMogr2/auto-orient/strip|imageView2/2/w/1240)
...
[![在这里插入图片描述](21分布式学习笔试.assets/19816137-bb046dbf19bee1b4.gif)](https://upload-images.jianshu.io/upload_images/19816137-bb046dbf19bee1b4.gif?imageMogr2/auto-orient/strip)
[
